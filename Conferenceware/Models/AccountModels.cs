...
namespace Conferenceware.Models
{
	...
	{
		private const string _stringRequiredErrorMessage =
			"Value cannot be null or empty.";

		public static void ValidateRequiredStringValue(string value,
	...
	public sealed class PropertiesMustMatchAttribute : ValidationAttribute
	{
		...
		public override bool IsValid(object value)
		{
			...
			object originalValue =
				properties.Find(OriginalProperty, true /* ignoreCase */).GetValue(value);
			object confirmValue =
				properties.Find(ConfirmProperty, true /* ignoreCase */).GetValue(value);
