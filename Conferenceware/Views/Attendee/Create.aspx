<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Conferenceware.Models.Attendee>" %>
...
<% Html.EnableClientValidation(); %>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <%= Html.HiddenFor(model => model.People.id, new {value="0"}) %>
