...
This simplicity of the design also allows for easy refactorings of the code. If one has a good understanding of the code, they can more easily make changes to the code that won't break other functionality. These refactorings should also be simple in design and fit together with the rest of the system if the system exhibits high modularity.
...
and stores it in the database. The server then returns a success message
to the user.

%% Oh god, importing pdfs
%% figure's [H] makes the figures show up RIGHT THERE, NO MATTER WHAT
...
For me, Conferenceware had its share of ups and downs. From initially creating 
and populating the Microsoft SQL Server 2008 Express database to pushing and 
pulling from the Git repository, I learned a great deal about technologies that 
I have never used before. Some of these experiences, working with Git in 
particular, leave me with no desire to use them in the future. Using Visual 
Studio 2010, while the rest of the group used Visual Studio 2008, proved to be 
difficult, but was desirable because of features that 2010 provided over 2008. 
One particularly annoying aspect of using Visual Studio 2010 is that I could not 
add new classes to the project because they would not be added to the C\# project 
file for 2008.
...
very consistent about committing changes and keeping tickets up to date. This, I
