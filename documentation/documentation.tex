...
\includegraphics[width=\textwidth]{AddEvent_sequence}
\end{figure}
\begin{figure}[H]
\centering
\caption{Manage Event Sequence Diagram}
\includegraphics[width=\textwidth]{ManageEvent_sequence}
\end{figure}
\begin{figure}[H]
\centering
\caption{Register Attendee Sequence Diagram}
\includegraphics[width=\textwidth]{RegisterAttendee_sequence}
\end{figure}
\begin{figure}[H]
\centering
\caption{TShirtSize Create Sequence Diagram}
\includegraphics[width=\textwidth]{TShirtSizeCreate_sequence}
\end{figure}
